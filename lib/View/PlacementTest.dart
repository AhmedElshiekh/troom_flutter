...
class PlacementTest extends StatelessWidget {
  static const Id = 'PlacementTest';
  String LOGD = 'PlacementTest';
  var localH;
  HomeCont _cont = Get.put(HomeCont());
  final _formKey = GlobalKey<FormState>();

  PlacementTest({this.localH});
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context,answerIndex){
                              return Column(
                                crossAxisAlignment: CrossAxisAlignment.center,
                                children: [
                                  // CustomText(txt: "${_cont.placementExamResData.sections[i].questions[Qindex].answers[answerIndex].answer} ?",txtColor: ConstStyles.TextColor  ,),
                                  RadioGroup<String>.builder(
                                    activeColor: ConstStyles.GreenColor,
                                    groupValue: _cont.selectedAnswers[i] == null ? 'loading...':_cont.selectedAnswers[i],
                                    onChanged: (selected){
                                      print('LessonExam ::: ${_cont.placementExamResData.sections[i].questions[Qindex].answers[answerIndex].key}');
                                      _cont.changeSelectedValue(selected, i);
                                      if(_cont.placementExamResData.sections[i].questions[Qindex].answers[answerIndex].key == _cont.placementExamResData.sections[i].questions[Qindex].correctAnswer){
                                        ...
                                        _cont.answersResult.insert(i, true);
                                      }else{
                                        print('RadioGroupSelected Result === False');
                                        _cont.answersResult.insert(i,false);
                                      }
                                    },
