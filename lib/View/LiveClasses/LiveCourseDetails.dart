                                    ...
                                    child: Align(
                                      ...
                                      child: SizedBox(
                                        ...
                                        child: GetBuilder<LiveCourseDetailsCont>(
                                          builder: (_){
                                            if(_courseDetailsCont.courseDetailsResData.image != null){
                                              return ClipRRect(
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                Container(
                                                  ...
                                                  child: Center(child: CustomText(txt: _courseDetailsCont.courseDetailsResData.category == null ? '' : _courseDetailsCont.courseDetailsResData.category,fontSize: localW * 0.05,)),
                                                ),
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      //   size: localW * 0.05,),
                                      Html(data:  _courseDetailsCont.courseDetailsResData.description == null ? ''
                                          : _courseDetailsCont.courseDetailsResData.description)
                                    ],
                                  ),
                                ),
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        padding: EdgeInsets.only(left: localW *0.1),
                                        child: Html(data: _courseDetailsCont.courseDetailsResData.requirements == null ? ''
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: localH * 0.02,),
                                      Html(data: _courseDetailsCont.courseDetailsResData.whatWillLearn == null ? ''
...
*/
                       ...
                       /*   //TODO Instructors
                          Container(
                            ...
                            width: localW ,
                            color: ConstStyles.WhiteColor,
                            margin: EdgeInsets.only(left: localW * 0.15,right: localW * 0.15,top: localH * 0.01),
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                ...
                                SizedBox(
                                  height: localH * 0.3,
                                  width: localW,
                                  child: GetBuilder<LiveCourseDetailsCont>(builder: (_){
                                    if(_courseDetailsCont.courseDetailsResData.teacher!=null &&
                                        _courseDetailsCont.courseDetailsResData.teacher.teacherImg!=null){
                                      return Container(
                                        height: localH * 0.3,
                                        decoration: BoxDecoration(
                                          image: DecorationImage(
                                            image: NetworkImage("${EndPoints.ImageUrl}${_courseDetailsCont.courseDetailsResData.teacher.teacherImg}"),
                                            fit: BoxFit.contain,
                                          ),
                                        ),
                                      );
                                      ...
                                      return  Container(
                                        ...
                                        child: Icon(Icons.person,size: localH * 0.3,),
                                      );
                                ...
                                SizedBox(
                                  width: localW,
                                  child: CustomText(txt: _courseDetailsCont.courseDetailsResData.teacher == null
                                      ? '' : _courseDetailsCont.courseDetailsResData.teacher.name,txtColor: ConstStyles.DarkColor,
                                    txtAlign: TextAlign.center,),
                                ),
