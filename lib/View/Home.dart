                            ...
                            child: FutureBuilder(
                              ...
                              builder: (context, snapshot) {
                                if (snapshot.connectionState == ConnectionState.done) {
                                  return AspectRatio(
                                      aspectRatio: _homeCont.controller.value.aspectRatio,
                                      child: VideoPlayer(_homeCont.controller));
                                } else {
                                  return Center(
                                          ...
                                          child: GetBuilder<HomeCont>(
                                            ...
                                            return SizedBox(
                                              ...
                                              child: CarouselSlider.builder(
                                                unlimitedMode: true,
                                                slideBuilder: (index) {
                                                  if (_homeCont.sliderList.length > 0) {
                                                    return slideWidget(localW, localH * 0.329,
                                                        _homeCont.sliderList[index]);
                                                  } else {
                                                    return SizedBox(
                                                        width: localW,
                                                        height: localH * 0.3,
                                                ...
                                                autoSliderTransitionTime: Duration(milliseconds: 5000),
                                                itemCount:  _homeCont.sliderList != null
                                                    ? _homeCont.sliderList.length
                                                    : 3,
                                              ),
                                            );
                                          }),
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        Container(
                                                          width: localW * 0.45,
                                                          child: CustomText(txt: 'AllLiveClasses'.tr,txtColor: ConstStyles.WhiteColor,
                                                            fontWeight: FontWeight.bold,
                                                            fontSize: localW * 0.07,),
                                                        ),
                                                      ],
                                                ...
                                                child: SizedBox(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      crossAxisAlignment: CrossAxisAlignment.center,
                                                      children: [
                                                        CustomText(txt: 'AllPrivateClasses'.tr,txtColor: ConstStyles.WhiteColor,
                                                          fontWeight: FontWeight.bold,
                                                          fontSize: localW * 0.07,),
                                                      ],
                                                    ),
                                  ...
                                  children: [
                                    ...
                                    SizedBox(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Container(
                                            padding:EdgeInsets.only(right: localW * 0.05),
                                            child: CustomText(
                                              txt: 'NewCourses'.tr,
                                          ...
                                          child: SizedBox(
                                            ...
                                            child: Container(
                                              ...
                                              child: Column(
                                                mainAxisAlignment: MainAxisAlignment.center,
                                                children: [
                                                  CustomText(txt: 'TestYourEnglishSkills'.tr,txtColor: ConstStyles.WhiteColor,
                                                    fontWeight: FontWeight.bold,
                                                    fontSize: localW * 0.07,),
                                                  CustomText(txt: 'TakePlacementTest'.tr,txtColor: ConstStyles.WhiteColor,
                                                    fontWeight: FontWeight.bold,
                                                    fontSize: localW * 0.07,),
                                                ],
                                              ),
                                               ...
                                               return GetBuilder<HomeCont>(
                                                  ...
                                                  if(_homeCont.liveCoursesList[index]!= null){
                                                    return InkWell(
                                                      ...
                                                      child: LiveCourseListItem(localH * 0.67, localW * 0.7, _homeCont.liveCoursesList[index],'EgyptianPound'.tr,
                                                          'More'.tr),
                                                    );
                                                  }else{
                                                    return LogoContainer();
                                              ...
                                              slideBuilder: (index) {
                                                if (_homeCont.ourTeachersList.length > 0) {
                                                  return Container(
                                                    ...
                                                    width: localW * 0.5,
                                                    height: localH * 0.3,
                                                    child: ourTeacherListItem(localW * 0.59, localH, _homeCont.ourTeachersList[index]),
                                                  );
                                                } else {
                                                  return SizedBox(
                                                      width: localW * 0.73,
                    ...
                    child: Align(
                      ...
                      child: SizedBox(
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            padding:  EdgeInsets.only(left: localW * 0.04,right:localW * 0.04 ),
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                                  ...
                                  if(item.btnUrl != null){
                                    return SizedBox(
                                      ...
                                      child: OrangeBtn(
                                        ...
                                        onClick: () {
                                          print(item.btnUrl);
                                          if(item.btnUrl == 'https://education.aisent.net/'){
                                            Get.back();
                                            Get.offAllNamed(Home.Id);
                                          }else{
                                            Get.to(()=>PayPalView(item.btnUrl));
                                          }
                                        },
                                        fontSize: 10,
                                      ),
            ...
            child: CircleAvatar(
              ...
              child: Container(
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image:
                    NetworkImage(EndPoints.ImageUrl + item.image.toString().replaceAll(RegExp(' '), '%20')),
                    fit: BoxFit.contain,
                  ),
                ),
              ),
